...
class TestSearchService(TestBrokerCommand):
    ...
    def test_120_has_clients(self):
        ...
        self.matchclean(out, "netmap/p-q.ny.ms.com", command)
        self.matchclean(out, "netmap/q.ny.ms.com", command)
    ...
    def test_130_no_clients(self):
        ...
        self.matchoutput(out, "netmap/p-q.ny.ms.com", command)
        self.matchoutput(out, "netmap/q.ny.ms.com", command)
