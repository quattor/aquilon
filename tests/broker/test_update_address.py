...
class TestUpdateAddress(TestBrokerCommand):
    ...
    def test_100_update_reverse(self):
        ...
        command = ["update", "address",
                   ...
                   "--comments", "Some address comments", "--justification", "tcm=123"]
    ...
    def test_108_clear_comments(self):
        ...
        self.noouttest(["update_address",
                        "--fqdn", "arecord15.aqd-unittest.ms.com",
                        "--comments", "", "--justification", "tcm=123"])
        self.dsdb_verify()
    ...
    def test_110_clear_ptr_override(self):
        command = ["update", "address",
                   "--fqdn", "arecord15.aqd-unittest.ms.com",
                   "--reverse_ptr", "arecord15.aqd-unittest.ms.com", "--justification", "tcm=123"]
        self.noouttest(command)
    ...
    def test_120_update_ip(self):
        ...
        command = ["update", "address",
                   "--fqdn", "arecord15.aqd-unittest.ms.com", "--ip", ip, "--justification", "tcm=123"]
        self.noouttest(command)
        self.dsdb_verify()
    ...
    def test_130_update_dyndhcp_noop(self):
        ...
        command = ["update", "address", "--fqdn", self.dynname(ip),
                   "--reverse_ptr", self.dynname(ip), "--justification", "tcm=123"]
        self.noouttest(command)
        self.dsdb_verify(empty=True)
    ...
    def test_140_restricted_reverse(self):
        command = ["update", "address",
                   ...
                   "--reverse_ptr", "reverse2.restrict.aqd-unittest.ms.com", "--justification", "tcm=123"]
    ...
    def test145_alias_reverse(self):
        command = ["update", "address",
                   "--fqdn", "arecord17.aqd-unittest.ms.com",
                   "--reverse_ptr", "alias2host.aqd-unittest.ms.com", "--justification", "tcm=123"]
        self.noouttest(command)
    ...
    def test150_address_alias_reverse(self):
        command = ["update", "address",
                   "--fqdn", "arecord17.aqd-unittest.ms.com",
                   "--reverse_ptr", "addralias1.aqd-unittest.ms.com", "--justification", "tcm=123"]
        self.noouttest(command)
    ...
    def test_200_update_dyndhcp(self):
        ip = self.net["dyndhcp0"].usable[12]
        command = ["update", "address", "--fqdn", self.dynname(ip),
                   "--reverse_ptr", "unittest20.aqd-unittest.ms.com", "--justification", "tcm=123"]
    ...
    def test_200_update_primary(self):
        command = ["update", "address",
                   ...
                   "--ip", self.net["unknown0"].usable[-1], "--justification", "tcm=123"]
        out = self.badrequesttest(command)
