...
class TestAddTorSwitch(TestBrokerCommand):
    ...
    def testverifyaddut3gd1r01(self):
        self.verifyswitch("ut3gd1r01.aqd-unittest.ms.com", "ut3", "a", "3", "SNgd1r01")
    ...
    def testrejectut3gd1r02(self):
        self.badrequesttest(["add", "machine",
    ...
    def testrejectut3gd1r03(self):
        self.badrequesttest(["add", "tor_switch",
    ...
    def testverifynp997gd1r04(self):
        self.verifyswitch("np997gd1r04.aqd-unittest.ms.com",
                          "np997", "zz", "99")

    def testverifyaddnp997gd1r04csv(self):
        command = "show tor_switch --tor_switch np997gd1r04.aqd-unittest.ms.com --format=csv"
        out = self.commandtest(command.split(" "))
        self.matchoutput(out, "np997gd1r04.aqd-unittest.ms.com,np997,np,hp,uttorswitch,,,", command)
    ...
    def testverifyaddnp998gd1r01csv(self):
        ...
        out = self.commandtest(command.split(" "))
        self.matchoutput(out, "np998gd1r01.aqd-unittest.ms.com,np998,np,hp,uttorswitch,,,", command)
    ...
    def testverifyaddnp999gd1r01csv(self):
        ...
        out = self.commandtest(command.split(" "))
        self.matchoutput(out, "np999gd1r01.aqd-unittest.ms.com,np999,np,hp,uttorswitch,,xge49,%s,%s" %
                (self.hostmac5, self.hostip5), command)
