...
CREATE TABLE "DYNAMIC_STUB" (
    "SYSTEM_ID" NUMBER(*,0),
    CONSTRAINT "DYNAMIC_STUB_PK" PRIMARY KEY (SYSTEM_ID),
    CONSTRAINT "DYNAMIC_STUB_SYSTEM_FK" FOREIGN KEY(SYSTEM_ID)
        REFERENCES "SYSTEM" ("ID") ON DELETE CASCADE
);

ALTER TABLE "DYNAMIC_STUB" MODIFY ("SYSTEM_ID"
    CONSTRAINT "DYNAMIC_STUB_SYSTEM_ID_NN" NOT NULL ENABLE);
