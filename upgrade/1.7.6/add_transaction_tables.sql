CREATE TABLE "XTN" (
    "XTN_ID"      CHAR(32) CONSTRAINT "XTN_XTN_ID_NN" NOT NULL,
...
CREATE TABLE "XTN_DETAIL" (
    "XTN_ID" CHAR(32) CONSTRAINT "XTN_DETAIL_XTN_ID_NN" NOT NULL,
    "NAME"   VARCHAR2(255) CONSTRAINT "XTN_DETAIL_NAME_NN" NOT NULL,
    "VALUE"  VARCHAR2(255) CONSTRAINT "XTN_DETAIL_VALUE_NN" NOT NULL,
...
CREATE TABLE "XTN_END" (
    "XTN_ID" CHAR(32) CONSTRAINT "XTN_END_XTN_ID_NN" NOT NULL,
    "RETURN_CODE" NUMBER(*,0) CONSTRAINT "XTN_END_RETURN_CODE_NN" NOT NULL,
    "END_TIME" DATE CONSTRAINT "XTN_END_END_TIME_NN" NOT NULL,
...
CREATE INDEX "XTN_COMMAND_IDX" ON "XTN" ("COMMAND") COMPRESS;
...
CREATE INDEX "XTN_END_RETURN_CODE_IDX" ON "XTN_END" ("RETURN_CODE") COMPRESS;
