...
CREATE TABLE "XTN" (
    "XTN_ID"      CHAR(32 BYTE) CONSTRAINT "XTN_ID_NN" NOT NULL,
    "USERNAME"    VARCHAR2(65 CHAR) CONSTRAINT "XTN_USERNAME_NN" NOT NULL,
    "COMMAND"     VARCHAR2(64 CHAR) CONSTRAINT "XTN_COMMAND_NN" NOT NULL,
...
CREATE TABLE "XTN_DETAIL" (
    "XTN_ID" CHAR(32 BYTE) CONSTRAINT "XTN_DTL_XTN_ID_NN" NOT NULL,
    "NAME"   VARCHAR2(255 CHAR) CONSTRAINT "XTN_DTL_NAME_NN" NOT NULL,
    "VALUE"  VARCHAR2(255 CHAR) DEFAULT 'True' CONSTRAINT "XTN_DTL_VALUE_NN" NOT NULL,
    CONSTRAINT "XTN_DTL_PK" PRIMARY KEY ("XTN_ID"),
...
CREATE TABLE "XTN_END" (
    ...
    "RETURN_CODE" INTEGER CONSTRAINT "XTN_END_RETURN_CODE" NOT NULL,
    "END_TIME" TIMESTAMP CONSTRAINT "XTN_END_TIME" NOT NULL,
