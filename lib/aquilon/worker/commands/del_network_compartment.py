...
"""Contains the logic for `aq del network_compartment`."""


from aquilon.exceptions_ import ArgumentError
from aquilon.worker.broker import BrokerCommand
from aquilon.aqdb.model import NetworkCompartment, Network


class CommandDelNetworkCompartment(BrokerCommand):
